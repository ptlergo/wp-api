...
class wp_ng_theme {
	...
	function enqueue_scripts() {
		...
		wp_enqueue_script( 'angular-core', 'https://ajax.googleapis.com/ajax/libs/angularjs/1.6.1/angular.min.js', array( 'jquery' ), '1.0', false );
		wp_enqueue_script( 'angular-resource', 'https://ajax.googleapis.com/ajax/libs/angularjs/1.6.1/angular-resource.js', array( 'angular-core' ), '1.0', false );
